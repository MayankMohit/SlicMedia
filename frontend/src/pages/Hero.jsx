import bgDay from '../assets/noiseLight.png';
import bgnight from '../assets/noiseDark.png';
    ...
    >
      <div className="flex items-center justify-start h-full">
        <div className="ml-15 mt-30">
          <div className="text-2xl font-bold text-gray-500 dark:text-gray-400 mb-10 ml-2 select-none">  
            B2B Service Agency
          </div>
          <p className="mt-4 text-[100px] w-[50rem] text-black font-bold font-sans leading-[6.3rem] tracking-[-4.8px] dark:text-gray-200 select-none">
            Designing <span className='cedarville-cursive-regular'>Visuals</span> that Elevate your Brand.
          </p>
          <p className="mt-15 text-2xl w-[30rem] text-gray-500 font-bold dark:text-gray-400 ml-2 select-none leading-[1.6rem]">
          ...
          <p className="mt-3 text-xl text-bold text-gray-600 dark:text-gray-400 mb-20 ml-2  select-none">
            Discover More 
