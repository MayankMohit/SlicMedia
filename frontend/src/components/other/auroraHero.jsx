...
import LensFlareCustom from "./lensFlare.jsx";
...
export const AuroraHero = () => {
  ...
  const backgroundImage = useMotionTemplate`radial-gradient(150% 400% at 50% 220%, #020617 50%, ${color})`;
  ...
  return (
    <motion.section
      ...
      className="relative grid min-h-screen place-content-center overflow-hidden bg-gray-950 px-4 py-24 text-gray-200 select-none"
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <motion.button
          ...
          className="group relative flex w-fit items-center gap-1.5 rounded-full bg-gray-950/10 px-4 py-2 text-gray-50 transition-all hover:bg-gray-950/50"
        >
          Schedule a Meet Now
